...
<body>
	...
	<div id="main">
		...
		<s:if test = "errorMessage != null">
			...
			<s:form action="BuyItemAction">    <!--  ← name = "XXX" を このActionのフィールドに送る  -->
				<table>
					<tr>
						<td>
							<span>商品名</span>
						...
						<td>             <!--  Action定義したsessionの buyItem_name というキー -->
							<s:property value="session.buyItem_name" />    <!--      property = 前のActionの中に含まれるフィールド？    -->
						</td>
					</tr>
